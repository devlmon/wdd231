...
function insertCourses(coursesArray) {
    let coursesHTML = coursesArray.map((course) => {
        if (course.completed) {
            return `
                <p class="course completed">${course.subject} ${course.number}</p>   
            `;
        }
        else {
            return `
                <p class="course">${course.subject} ${course.number}</p>   
            `;
        }
    });
